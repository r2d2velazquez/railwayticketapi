...
def clean_downloads_dir():
    ...
    with cleanup_lock:
        try:
            ...
            logger.info(f"Cleaned {deleted_count} items from /tmp/downloads")
            return True
...
class ServiceStore:
    ...
    def setup_stealth_driver(self):
        ...
        chrome_options.add_argument("--headless")  # Must run headless on Railway
        ...
        chrome_options.add_argument("--disable-javascript")  # Only if your forms don't need JS
        ...
        # Anti-detection options (still useful)
...
def health_check():
    return jsonify({
        'status': 'healthy',
        'service': 'selenium-automation-api',
        'server': 'waitress',
        'timestamp': time.time()
    })
...
# ... [Keep all your existing routes and functions] ...
